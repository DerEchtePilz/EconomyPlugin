...
import me.derechtepilz.economy.inventory.*;
import me.derechtepilz.economy.inventory.ItemCancelMenu;
...
import me.derechtepilz.economy.inventory.TradeMenu;
...
public final class Main extends JavaPlugin {
    ...
    private final List<ItemStack[]> specialOffers = new ArrayList<>();
    ...
    public void onEnable() {
        ...
        itemBuyMenu = new ItemBuyMenu(this);
    ...
    public List<ItemStack[]> getSpecialOffers() {
