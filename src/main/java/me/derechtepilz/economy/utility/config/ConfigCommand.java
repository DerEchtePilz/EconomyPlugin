...
public class ConfigCommand {
    public ConfigCommand() {
        new CommandTree("config")
                ...
                .then(new LiteralArgument("discordToken")
                        .then(new StringArgument("discordToken")
                                .executesPlayer((player, args) -> {
                                    ...
                                    Config.set(ConfigFields.DISCORD_BOT_TOKEN, (String) args[0]);
                                    Config.reloadConfig();
                                    player.sendMessage(TranslatableChatComponent.read("configCommand.discordToken").replace("%s", (String) args[0]));
                                })))
